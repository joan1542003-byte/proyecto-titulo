# Descartada: prueba de evidencia 7.1–7.4 v1

**Estado:** rechazada en auditoría.

La prueba se conserva únicamente como historial de exploración. No debe utilizarse como página de la memoria ni como referencia vigente.
...
- **Cambio:** se movieron la imagen y su registro desde `02_pruebas_con_texto_real/02_evidencia/` a esta carpeta.
- **Versión anterior:** la v1 estaba clasificada como referencia de composición condicionada.
- **Motivo:** la auditoría detectó encabezado inventado, uso incorrecto del rojo, recurso ornamental dominante y pie no APA.
- **Alcance:** no se eliminó ningún archivo; la v1 queda disponible como historial y no como dirección vigente.
