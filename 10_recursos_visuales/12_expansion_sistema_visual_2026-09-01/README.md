...
| Editorial | 10 | 20 | Series 11–30 disponibles; la 21–30 requiere auditoría individual |
| Carteles | 10 | 16 | Series 11–26 disponibles; no priorizar nuevas piezas |
| Módulos transparentes | 10 | 10 | Alfa verificado |
| Fondos | 10 | 0 | Pendiente |
| Maquetas de memoria A3 | — | 7 | Serie inicial auditada como composición |
| **Total** | **50** | **61** | **En desarrollo** |
...
- [`06_documento_editorial_memoria/guia-maqueta-A3-horizontal.md`](06_documento_editorial_memoria/guia-maqueta-A3-horizontal.md): sistema de composición para convertir la memoria en una publicación A3 horizontal.
- [`06_documento_editorial_memoria/auditoria-maquetas-A3.md`](06_documento_editorial_memoria/auditoria-maquetas-A3.md): riesgos de contenido y condiciones de reconstrucción de la serie A3.
...
- **Versión anterior:** el plan trataba editorial, carteles y módulos como familias equivalentes y permitía una presencia más amplia de la gramática de puntos.
- **Motivo:** concentrar la producción en una publicación continua, donde cada recurso gráfico responda a una función de lectura.
- **Alcance:** los carteles y módulos ya existentes se conservan como exploración, pero no gobiernan la maqueta de la memoria.

### 2026-09-01 — Maquetas A3 y conteo actualizado

- **Cambio:** se registraron siete maquetas editoriales A3 y la disponibilidad real de las series editoriales y de carteles producidas después del primer corte.
- **Versión anterior:** la tabla contabilizaba solo las treinta y ocho piezas del primer lote de expansión.
- **Motivo:** evitar que el índice visual oculte recursos disponibles y dejar explícita la prioridad editorial.
- **Alcance:** el aumento de cantidad no implica que cada archivo sea arte final ni contenido académico aprobado.

### 2026-09-01 — Apertura de la expansión
