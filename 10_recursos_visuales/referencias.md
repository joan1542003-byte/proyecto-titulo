# Referencias de la investigación visual
...
| Área | Fuentes principales | Alcance dentro de Relevo |
| --- | --- | --- |
...
Android Developers. (s. f.-b). *Themes*. Recuperado el 11 de septiembre de 2026, de https://developer.android.com/design/ui/mobile/guides/styles/themes

Android Developers. (s. f.-c). *10 steps for translating designs to Android*. Recuperado el 11 de septiembre de 2026, de https://developer.android.com/design/ui/mobile/guides/foundations/translate-designs
...
Instituto Nacional de Propiedad Industrial. (s. f.). *Preguntas frecuentes: Marcas*. Recuperado el 11 de septiembre de 2026, de https://www.inapi.cl/preguntas-frecuentes/marcas

International Organization for Standardization. (2010a). *ISO 24500:2010 Ergonomics—Accessible design—Auditory signals for consumer products*. https://www.iso.org/standard/46170.html

International Organization for Standardization. (2010b). *ISO 24501:2010 Ergonomics—Accessible design—Sound pressure levels of auditory signals for consumer products*. https://www.iso.org/standard/46171.html

International Organization for Standardization. (2010c). *ISO 24502:2010 Ergonomics—Accessible design—Specification of age-related luminance contrast for coloured light*. https://www.iso.org/standard/46172.html

International Organization for Standardization. (2019a). *ISO 9241-210:2019 Ergonomics of human-system interaction—Part 210: Human-centred design for interactive systems*. https://www.iso.org/standard/77520.html
...
Norman, D. A. (2002). *The design of everyday things* (Rev. and expanded ed.). Basic Books.

one sec. (s. f.). *one sec*. Recuperado el 11 de septiembre de 2026, de https://one-sec.app/

Opal OS Corporation. (s. f.). *Opal*. Recuperado el 11 de septiembre de 2026, de https://opalapp.com/

U.S. Web Design System. (s. f.). *Design tokens*. Recuperado el 11 de septiembre de 2026, de https://designsystem.digital.gov/design-tokens/

Unpluq. (s. f.). *Unpluq*. Recuperado el 11 de septiembre de 2026, de https://www.unpluq.com/

Voit, A., Kosch, T., Weingärtner, H., & Woźniak, P. W. (2021). The Attention Kitchen: Comparing modalities for smart home notifications in a cooking scenario. In *Proceedings of the 20th International Conference on Mobile and Ubiquitous Multimedia* (pp. 90–97). Association for Computing Machinery. https://doi.org/10.1145/3490632.3490660
...
World Wide Web Consortium. (2021). *Objective 3: Use clear and understandable content*. https://www.w3.org/WAI/WCAG2/supplemental/objectives/o3-clear-content/
...
- **Qué cambió:** se consolidaron las fuentes empleadas, su función dentro del estudio y sus referencias en formato APA 7.
- **Cómo era antes:** la documentación visual anterior mezclaba enlaces, bibliografías parciales y referencias de producción sin una lista vigente única.
- **Por qué se decidió:** permitir que cada afirmación del nuevo estudio pueda rastrearse y distinguir evidencia académica, normativa y comercial.
- **Límite:** las páginas comerciales describen sus propias propuestas y pueden cambiar; no prueban por sí mismas la eficacia de esos productos.
