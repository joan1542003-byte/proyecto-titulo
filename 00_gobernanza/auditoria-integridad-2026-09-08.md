...
| Control | Resultado |
| --- | --- |
| Enlaces locales en Markdown | 347 archivos y 1.025 referencias locales comprobadas; 0 rotas. |
...
- **Resultado:** 1.025 enlaces locales, 14 JSON, 743 PNG y 5 contenedores comprobados sin errores.
