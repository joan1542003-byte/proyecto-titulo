...
|---|---|---|---|
| **2–6 septiembre 2026** | Inventariar materiales, revisar B1/B2, construir wireframe mínimo.. | Revisar y validar funcionamiento, verificar que el desarrollo responda a las directrices de diseño y de Relevo. | [Alternativas físicas](../06_desarrollo_y_factibilidad/alternativas-arquitectura-fisica-2026-08-30.md) · [Plan](plan-de-cierre-agosto-diciembre-2026.md) |
