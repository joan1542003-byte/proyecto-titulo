...
- **Qué cambió:** se añadió una ruta corta al archivo `CLAUDE.md`, al prompt de inicio y al traspaso con estado de Android 2.6.
- **Cómo estaba antes:** el índice remitía a instrucciones de ChatGPT/Codex y auditorías anteriores, sin ruta para una conversación nueva en Claude.
- **Por qué:** permitir que otro asistente llegue al material vigente y conozca explícitamente el corte temporal del traspaso.
...
- **Qué cambió:** el índice diferencia la dirección visual provisional de las decisiones todavía abiertas.
- **Cómo estaba antes:** indicaba que paleta y tipografía seguían completamente indeterminadas.
- **Por qué se decidió:** conducir al lector a la especificación realmente vigente sin confundirla con una identidad validada.
- **Alcance:** no modifica el sistema anterior conservado en la etiqueta Git ni acredita resultados de prueba.

### 2026-09-11 — Reinicio visual incorporado

- **Qué cambió:** el índice dirige a la nueva investigación escrita y deja de presentar piezas, tipografías o colores anteriores como vigentes.
- **Cómo estaba antes:** describía `10_recursos_visuales` como una biblioteca activa de gráficos y exportaciones y enlazaba una dirección cerrada el 7 de septiembre.
- **Por qué se decidió:** la revisión integral mostró alternativas incompatibles y decisiones no probadas; el nuevo apartado vuelve a separar investigación, hipótesis y especificación.
- **Alcance:** la estructura funcional del wireframe v1 se conserva, pero su apariencia no gobierna la interfaz futura.
