...
Para estudiar esta situación se combinaron una revisión de literatura, el análisis de referentes y mercado, y ocho entrevistas semiestructuradas, habladas y presenciales, realizadas en Santiago los días 11 y 12 de junio de 2026. El reclutamiento se hizo mediante referencias y tuvo la edad como único criterio común confirmado; las personas entrevistadas tenían entre 19 y 27 años, incluido P6, de 27 años. El análisis por episodios permitió distinguir dos posiciones: un usuario principal situacional —cuando la continuidad digital coexiste con una intención alternativa— y un usuario límite —cuando el ocio digital es elegido, significativo o coherente con la intención del momento—. Debido a su carácter exploratorio, el corpus no permite estimar prevalencia, describir el uso doméstico ni evaluar Relevo.

De esta investigación surge una hipótesis phygital. Mediante una aplicación Android, la persona registra una intención y configura una condición de activación todavía abierta; luego sitúa un testigo físico junto al primer paso de la actividad elegida. Cuando se cumple la condición, el testigo emite un pulso ambiental. Una notificación equivalente servirá como control comparativo, no como salida final del sistema. La investigación deberá establecer si la presencia situada ofrece un valor propio y si ese aporte compensa la configuración, el mantenimiento, el costo, los riesgos de privacidad y una posible sensación de intrusión.

Además de fundamentar el problema y la propuesta, la memoria documenta la evidencia de usuarios, el mercado, los criterios de diseño, los flujos, la producción y la gestión. El ciclo mínimo quedó organizado en tres interacciones, nueve marcos de síntesis y 35 estados que cubren configuración, vinculación, prueba, armado, espera, señal, cierre y recuperación. Los *wireframes* —esquemas que ordenan contenido, acciones y jerarquías antes del diseño visual definitivo— son resultados del desarrollo proyectual, pero todavía no constituyen pruebas de uso. Para evaluarlos se propone una ruta progresiva P0–P4, desde la asociación con una señal simulada hasta un piloto integrado y acotado. Como esas pruebas aún no se han ejecutado, la contribución actual reside en la investigación, la formulación, la arquitectura, el desarrollo estructural y el método; el aporte del artefacto sigue condicionado a la evidencia futura.
...
The study combines a literature review, an analysis of references and current products, and eight spoken, in-person semi-structured interviews conducted in Santiago on June 11 and 12, 2026. Participants were recruited through referrals, with age as the only confirmed common criterion; they ranged from 19 to 27 years old, including P6 at age 27. Episode-based analysis supported two situational positions: a primary user, when digital continuity coexists with an alternative intention, and a boundary user, when digital leisure is chosen, meaningful, or aligned with the person’s current intention. Because the study is exploratory, the corpus does not estimate prevalence, describe domestic use, or evaluate Relevo.

This evidence leads to a phygital hypothesis. Through an Android application, the person records an intention and configures an activation condition that remains open for testing; the person then places a physical token next to the first step of the chosen activity. When the condition is met, the token emits an ambient pulse. An equivalent phone notification will serve as a comparative control rather than the system’s final output. The project must establish whether situated physical presence offers a distinct value and whether that contribution offsets configuration, maintenance, cost, privacy, and intrusion risks.

Alongside the problem and proposal, this report documents user evidence, the market, design criteria, system flows, production, and management. The minimum cycle is organized into three interactions, nine synthesis frames, and 35 states covering configuration, pairing, testing, arming, waiting, signalling, closure, and recovery. These wireframes are project-development outcomes, not usability evidence. A progressive P0–P4 route is proposed for evaluation, from simulated association to a limited integrated pilot. Since these tests have not yet been conducted, the current contribution lies in research, formulation, architecture, structural development, and method; the artifact’s contribution remains conditional on future evidence.
...
La pertinencia disciplinar está en proyectar una experiencia distribuida entre interfaz, objeto, espacio y decisión. Fabricar un dispositivo conectado sería insuficiente si antes no se establece qué relación entre intención, señal y contexto merece existir, cuándo conviene no activarla y qué carga agrega durante su producción, uso, mantenimiento y retiro. El carácter phygital proviene de esa distribución: la capa digital conserva el significado y prepara la regla, mientras el testigo sitúa un pulso ambiental en el lugar donde puede comenzar la actividad elegida. Su aporte deberá comprobarse frente a una notificación equivalente.
...
El recorrido comienza con la construcción del problema y su formulación proyectual, para luego explicar la metodología, el marco teórico y la evidencia de usuarios. A partir de esa base, el estado del arte y el mercado permiten reconocer mecanismos existentes, sus límites y la oportunidad específica de Relevo.

Los capítulos siguientes convierten la investigación en criterios, decisiones y una arquitectura de experiencia. Allí se definen el sistema, sus flujos, la producción, la factibilidad y el modelo de gestión. Finalmente, el plan P0–P4 ordena las pruebas todavía pendientes y las conclusiones separan con claridad lo que el proyecto ya aporta de aquello que solo podrá sostenerse después de prototipar y evaluar.
...
El aumento de fidelidad responde a preguntas encadenadas. P0 comienza con una activación simulada para saber si la relación entre intención, lugar y señal se comprende; solo después, P1 compara el valor del lugar con una ubicación neutra y una notificación. P2 permite escoger el canal y la forma de detener la señal, mientras P3 traslada la pregunta a la ejecución técnica y sus fallos. Si esas etapas ofrecen evidencia suficiente, P4 integra el sistema en un piloto acotado. En todos los casos, el registro debe precisar tanto lo aprendido como los aspectos que permanecen abiertos.
...
| Concepto | Función en el proyecto | Límite |
| --- | --- | --- |
