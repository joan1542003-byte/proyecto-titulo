...
El archivo [relevo_fase_a.ino](relevo_fase_a.ino) implementa únicamente el comportamiento necesario para el [montaje mínimo](../montaje-luminoso-12v.md). No contiene Bluetooth, Android, almacenamiento, intenciones ni historial.
