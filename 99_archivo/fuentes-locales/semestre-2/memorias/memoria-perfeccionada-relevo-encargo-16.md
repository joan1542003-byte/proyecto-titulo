---
id: FL-S2-MEM-002
titulo: "Memoria perfeccionada de Relevo — Encargo 16"
autoria: propia
estado_documental: histórico
relacion_con_proyecto: "versión candidata de la memoria del semestre 2"
sensibilidad: anonimizada
fuente_local_relativa: "SEMESTRE 2/output/Johan Yanten - Memoria perfeccionada Relevo - Encargo 16.docx"
formato_fuente: docx
fuente_sha256: 4ab82f82649a8b55215bfdca1b32f4a2353b51841eb123ab75d415c23d3bcc2f
modificacion_local: "2026-08-15T19:47:06-04:00"
metodo_conversion: "extracción estructural de párrafos, listas y tablas mediante OOXML"
fecha_migracion: 2026-08-23
---

# Memoria perfeccionada de Relevo — Encargo 16
...
**MEMORIA DE PROYECTO DE TÍTULO  ·  SEGUNDO SEMESTRE  ·  ENCARGO 16**
...
6. Estado del arte: qué existe y qué falta
...
11. Encargo 16: arquitectura de experiencia
...
*Relevo como testigo compacto, sin pantalla, con señal luminosa, sonora y vibratoria configurable*

> **Figura conservada en la fuente DOCX:** image1.png. Véase el [manifiesto de medios](manifesto-de-medios.md).

*Nota.* Visualización conceptual generada con IA bajo dirección de diseño del autor; no representa un prototipo validado. Elaboración propia, 2026.
...
*Cadena de trazabilidad desde teoría y evidencia hasta requisitos del objeto*
...
El perfil primario es un adulto joven que valora su ocio digital, reconoce algunas sesiones poco deliberadas y puede formular una actividad que quiere mantener disponible. Quedan fuera quienes buscan bloqueo estricto, no reconocen la brecha o requieren intervención clínica. El hogar se elige porque las alternativas poseen objetos y lugares observables y permite probar distancia, convivencia, privacidad y guardado. La casa forma parte del sistema, no es un fondo neutro.
...
1. **Diseñar:** comparar tipologías y desarrollar un testigo sin pantalla coherente con situación, autonomía, percepción, privacidad, energía y costo.

1. **Validar:** contrastar ubicación congruente y neutra, y explorar después el valor frente a una notificación mediante puertas explícitas de cambio o abandono.
...
El análisis se organiza por operación, no por parecido formal. Los precios son referencias dinámicas y no prueban demanda local.

**Tabla 4**

*Referentes comparados por operación*

> **Tabla 4:** conversión estructural desde la tabla de Word.

| Referente | Operación | Aprendizaje y límite para Relevo |
| --- | --- | --- |
| one sec | Inserta fricción antes de una app (one sec, s. f.). | Pausa sin bloqueo; permanece en el teléfono. |
| Brick | Acerca el teléfono a una pieza para cambiar acceso (Brick LLC, s. f.). | Gesto tangible claro; lógica principal de restricción. |
| Aro | Deposita el teléfono en una caja conectada (Aro, s. f.). | Ritual visible; costo y volumen mayores. |
| Tangible Reminder | Asocia tareas digitales con piezas físicas (Hermann et al., 2007). | Precedente directo de señal tangible; otro contexto técnico. |
| AirTag, 2.ª generación | Objeto circular compacto, audible y reemplazable (Apple Inc., s. f.). | Referencia tipológica y dimensional; no se adopta rastreo, UWB, NFC, iOS ni lenguaje formal. |

*Nota.* Elaboración propia a partir de documentación pública consultada el 15 de agosto de 2026.

Al 15 de agosto de 2026, Brick publicaba USD 59 y Aro ofrecía reacondicionados desde USD 149. La comparación no valida un precio para Relevo. El vacío seleccionado combina cuatro elementos que los referentes no reúnen: intención autoformulada, condición digital elegida, clave física junto al primer paso y ausencia de bloqueo o registro conductual.

## 7. Del criterio a la forma

### 7.1 Tres familias

Se compararon tres arquitecturas: una **pinza situada**, muy próxima a la actividad pero difícil de adaptar sin dañar materiales; un **faro fijo**, perceptible aunque débilmente asociado con distintos primeros pasos; y un **testigo transportable**, capaz de acompañar lugares diversos. Las imágenes son exploraciones conceptuales generadas con IA y no preferencias de usuarios.
...
*Nota.* Visualizaciones conceptuales generadas con IA bajo dirección de diseño del autor, 2026.

Los pesos y puntajes de selección son juicio del autor. Bajo criterios de coherencia, asociación espacial, percepción, privacidad, autonomía, factibilidad y costo, el testigo transportable obtuvo la evaluación más alta. El resultado organiza una decisión proyectual; no constituye evidencia de preferencia ni desempeño.

### 7.2 Por qué no usa pantalla ni cuna

Una pantalla explicita la intención, pero agrega costo, energía, espesor y exposición doméstica. Eliminarla obliga a probar la asociación entre intención, testigo y lugar: esa desventaja es a la vez el núcleo investigable. La cuna aportaba guardado y carga, pero duplicaba carcasa, contactos y volumen. La carga USB-C directa conserva una sola pieza; una bandeja pasiva solo se considerará si el token se pierde o no encuentra un lugar habitual.
...
*Nota.* Visualización conceptual generada con IA; no representa un prototipo validado. Elaboración propia, 2026.
...
La persona define una intención y un primer paso, selecciona condición y modalidad, sitúa el testigo y prueba alcance. La app prepara la regla; una pulsación prolongada de dos segundos alterna armado y desarmado. Al cumplirse la condición, Android envía un comando local y Relevo ejecuta una sola secuencia. Una pulsación breve la silencia; si nadie interviene, termina sola. La regla queda inactiva hasta un nuevo armado y el producto no pregunta qué hizo la persona.

**Figura 5**

*Secuencia principal: formular, armar, situar, detectar, señalar, silenciar y decidir fuera del sistema*

> **Figura conservada en la fuente DOCX:** image4.png. Véase el [manifiesto de medios](manifesto-de-medios.md).
...
> **Figura conservada en la fuente DOCX:** image5.png. Véase el [manifiesto de medios](manifesto-de-medios.md).
...
### 10.1 Resultados e interpretación
...
*Secuencia de prototipos, evidencia y puertas de decisión*

> **Figura conservada en la fuente DOCX:** image6.png. Véase el [manifiesto de medios](manifesto-de-medios.md).
...
El Encargo 16 solicita tres mapas A3 para un perfil y dos metas SMART de corto plazo. Los mapas se desarrollan como entregables independientes y se sintetizan aquí. Todos se corrigen para la versión sin pantalla: no hay cuna, OLED, encoder, menú de cuatro respuestas ni registro conductual.

### 11.1 Mapa de viaje de usuario

El viaje recorre conciencia, consideración, onboarding, uso, retención y recomendación. La adopción incluye permiso, vínculo, intención, primer paso, señal de prueba y ubicación. En uso, la decisión posterior queda fuera del límite del sistema. Retención significa que la persona sigue encontrando pertinente rearmar y situar el token, no que acumule días.

**Figura 8**

*Mapa de viaje de usuario para Relevo sin pantalla. Versión A3 disponible como entregable independiente*

> **Figura conservada en la fuente DOCX:** image7.png. Véase el [manifiesto de medios](manifesto-de-medios.md).

*Nota.* Elaboración propia, 2026.

### 11.2 Flujo funcional

El flujo visible comienza en la app Android, verifica permiso y vínculo, configura regla y modalidad, prueba la señal y termina al situar el testigo. Cuando se cumple la condición, el sistema comprueba batería y conexión, activa un patrón acotado y vuelve a reposo. La persona decide fuera de Relevo; el producto no clasifica esa decisión.

**Figura 9**

*Flujo funcional centrado en las acciones y decisiones visibles para la persona. Versión A3 disponible como entregable independiente*

> **Figura conservada en la fuente DOCX:** image8.png. Véase el [manifiesto de medios](manifesto-de-medios.md).

*Nota.* Elaboración propia, 2026.

### 11.3 Flujo técnico

El flujo técnico separa persona, app, sistema Android, BLE y testigo. Incluye permiso revocado, restricciones de segundo plano, batería baja, desconexión, reintento acotado y prohibición de reproducir tarde. El testigo recibe un comando de patrón, no el texto de la intención.

**Figura 10**

*Flujo técnico Android–BLE–testigo y manejo de excepciones. Versión A3 disponible como entregable independiente*

> **Figura conservada en la fuente DOCX:** image9.png. Véase el [manifiesto de medios](manifesto-de-medios.md).

*Nota.* Elaboración propia, 2026.

### 11.4 Metas SMART para las próximas 72 horas

1. **Antes del 18 de agosto de 2026 a las 18:00**, presentar tres maquetas de 40, 44 y 48 mm a cinco adultos jóvenes, pedirles que configuren una intención, elijan una ubicación y recuperen intención y primer paso después de una activación simulada; documentar al menos cinco confusiones y decidir diámetro, apoyo y necesidad de etiqueta.

1. **Antes del 18 de agosto de 2026 a las 21:00**, montar un prototipo sin pantalla con LED, piezo, motor vibratorio y botón; completar diez secuencias en madera, tela y piso, medir percepción desde dos distancias y seleccionar dos perfiles de señal para la prueba comparativa.

### 11.5 Plan de cierre en treinta días

Durante la primera semana se corrigen mapas y se construyen maquetas P0. En la segunda se realizan pruebas de asociación, forma y modalidad. En la tercera se itera carcasa y se integra activación remota P1. En la cuarta se incorporan resultados reales, fotografías, decisiones y límites a la memoria. Una versión diagramada sin resultados inventados puede estar cerrada en treinta días; la validación longitudinal y la integración completa continúan durante el semestre.
...
1. Configura una actividad que quieras mantener disponible y define su primer paso.

1. ¿Dónde pondrías el testigo? Explica por qué ese lugar tiene sentido.

1. Después de la señal, ¿qué intención representa y cuál era el primer paso?

1. ¿Qué parte del lugar o del objeto te ayudó a recordarlo?

1. Presiona para silenciar y luego desarma. ¿Qué crees que hizo cada gesto?

1. ¿Se sintió como invitación, alarma, reproche u otra cosa? ¿Por qué?

1. ¿Qué cambiarías para querer conservarlo en tu casa?

### B.2 Guion de modalidad y convivencia

1. ¿Qué señales percibiste desde cada habitación y superficie?

1. ¿Cuál combinación fue más clara sin ser molesta?

1. ¿En qué situación desactivarías sonido, luz o vibración?

1. ¿La señal revelaría algo que no quieras compartir con convivientes?

1. ¿La vibración se sintió táctil, sonora o no se percibió?

1. ¿Qué duración e intensidad te parecieron suficientes?
...
- **Estado anterior:** archivo local SEMESTRE 2/output/Johan Yanten - Memoria perfeccionada Relevo - Encargo 16.docx sin copia textual navegable en GitHub.
...
|---|---|---|
| Cuestionario digital con repreguntas generadas por IA | Ocho entrevistas semiestructuradas presenciales; preguntas y repreguntas formuladas por el investigador | Aclaración directa del investigador |
