---
id: FL-S2-MEM-003
titulo: "Memoria de Relevo — Sistema editorial v3"
autoria: propia
estado_documental: histórico
relacion_con_proyecto: "versión candidata de la memoria del semestre 2"
sensibilidad: anonimizada
fuente_local_relativa: "SEMESTRE 2/output/Johan Yanten - Memoria Relevo - Sistema editorial v3.docx"
formato_fuente: docx
fuente_sha256: 525edebd9bef5246adc7e80f323b5ca3670aaea982f15afde520384eb0d6ae1d
modificacion_local: "2026-08-15T20:46:32-04:00"
metodo_conversion: "extracción estructural de párrafos, listas y tablas mediante OOXML"
fecha_migracion: 2026-08-23
---

# Memoria de Relevo — Sistema editorial v3

## Nota archivística

Rama editorial propia con la modificación local más reciente de las tres fuentes auditadas. Esa fecha no basta para declararla memoria vigente.

La fuente contiene 370 párrafos, 14 tablas y 11 formas en línea. Se detectaron 11 archivos de medios internos. Los medios se registran en un manifiesto separado y no se publican en esta fase porque la entrega actual no exige visualidad y primero debe resolverse la duplicación entre versiones.
...
11. Encargo 16: arquitectura de experiencia    19
...
*Síntesis del mapa de viaje de usuario para Relevo sin pantalla*

> **Figura conservada en la fuente DOCX:** image9.png. Véase el [manifiesto de medios](manifesto-de-medios.md).

*Nota.* La trayectoria es hipotética y cada etapa formula una puerta de evidencia; la versión A3 completa se entrega por separado.

### 11.2 Flujo funcional

El flujo visible comienza en la app Android, verifica permiso y vínculo y configura regla y modalidad. Después, la persona elige un lugar, sitúa el testigo, prueba la señal y lo arma. Cuando se cumple la condición, el sistema comprueba batería y conexión, activa un patrón acotado y vuelve a reposo. La persona decide fuera de Relevo; el producto no clasifica esa decisión.

**Figura 9**

*Síntesis del flujo funcional centrado en acciones y decisiones visibles para la persona*

> **Figura conservada en la fuente DOCX:** image10.png. Véase el [manifiesto de medios](manifesto-de-medios.md).

*Nota.* La versión A3 completa se entrega por separado.
...
*Síntesis secuencial del flujo técnico Android–BLE–testigo*

> **Figura conservada en la fuente DOCX:** image11.png. Véase el [manifiesto de medios](manifesto-de-medios.md).

*Nota.* La versión A3 completa incorpora capas y excepciones y se entrega por separado.
...
2. **Antes del 18 de agosto de 2026 a las 21:00**, montar un prototipo sin pantalla con LED, piezo, motor vibratorio y botón; completar diez secuencias en madera, tela y piso, medir percepción desde dos distancias y seleccionar dos perfiles de señal para la prueba comparativa.
