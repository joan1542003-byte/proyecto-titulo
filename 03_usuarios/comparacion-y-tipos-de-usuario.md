...
```mermaid
stateDiagram-v2
    [*] --> Elegido: actividad coincide con la intención
    Elegido --> Desplazado: aparece una necesidad o alternativa y la sesión continúa
    Desplazado --> Elegido: la persona elige conscientemente continuar
    Desplazado --> Transicion: la persona recupera la intención
    Transicion --> [*]: inicia otra actividad o cierra la sesión
```
