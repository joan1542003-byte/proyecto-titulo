# Reconstrucciones de caso — P1–P8
...
- **Cambio:** se reconstruyeron por separado los ocho casos a partir de Q1–Q13, con evidencia, interpretación, tensión, códigos y confianza.
- **Versión anterior:** las respuestas existían en documentos combinados y resúmenes, pero no había reconstrucciones anónimas comparables.
- **Motivo:** preservar la coherencia de cada caso antes de construir patrones entre personas.
- **Decisión derivada:** tratar los futuros tipos como patrones de episodios; P4, P6 y P8 muestran que una persona puede aportar evidencia tanto de intervención como de no intervención.
