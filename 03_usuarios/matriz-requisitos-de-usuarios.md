...
| RU-03 | E | P6 aporta un episodio extenso que conserva sentido y distingue usos rutinarios que pueden sentirse desaprovechados; P7 y P8 describen episodios elegidos o aceptados. | U2: proteger ocio elegido, relacional, concentrado o reparador. | La activación debe depender de un ciclo voluntario vigente, no de una regla universal aplicada a todo uso digital. | Permanecer inactivo es una respuesta correcta cuando no existe una intención alternativa configurada. | P6–P8, Q3–Q13; confianza alta para el contraste, no para afirmar que todo uso rutinario conserva sentido. | P0 | Pruebas de escenarios U2: reconocer casos donde no corresponde armar o donde debe cerrarse el ciclo. | Especificado; no validado. |
...
| RU-13 | E + T | P7 rechaza notas y comparaciones; la literatura muestra que las rachas pueden sostener participación, pero también volverse una meta propia. | U1: recibir apoyo sin presión. U2: mantener legitimidad del ocio. | El prototipo no utiliza puntajes, rachas ni premios. Puede reconocer una elección comprobable, como preparar una actividad, y debe permitir ignorar la señal o cambiar de idea sin reproche. | Ninguna respuesta se clasifica como éxito o fracaso ni se afirma que la persona realizó una actividad que Relevo no observó. Una racha futura exigiría otra decisión y prueba, no se infiere de este requisito. | P3, P5 y P7–P8, Q9–Q13; Smit et al. (2019) y Silverman y Barasch (2023), sintetizados en [revisión de hábitos](../02_investigacion/habitos-reconocimiento-y-rachas-2026-09-23.md). Confianza media para el límite y baja para cualquier variante nueva en Relevo. | P0 | Auditoría de textos, métricas e historial; comparar reconocimiento informativo con texto neutro y preguntar si resulta útil, infantil o presionante. | Criterio revisado; sin validación con usuarios. |
...
- **Qué cambió:** RU-08 indica que la señal es solo sonora y declara la tensión con las preferencias visuales.
- **Cómo estaba antes:** decía que luz y sonido estaban seleccionados.
- **Por qué:** decisiones del autor D-070 (ampliada), D-078 y D-079.

### 2026-09-23 — Límite ético y apoyo positivo diferenciados

- **Cambio:** RU-13 mantiene la prohibición de calificar la decisión o fingir una actividad observada, pero distingue ese límite del estudio de reconocimiento positivo y de rachas voluntarias futuras.
- **Antes:** la fila excluía rachas y recompensas de forma absoluta, sin distinguir la versión del prototipo de opciones que podrían investigarse ni confrontar evidencia favorable y desfavorable.
- **Por qué:** incorporar el feedback docente sin convertir una preferencia, una métrica de la app o una investigación externa en resultado de Relevo.
- **Alcance:** requisito escrito; no se incorporan rachas, premios o nuevas notificaciones al producto.

### 2026-09-09 — Respuesta al feedback del 2 de septiembre

- **Cambio:** Se corrigió RU-08 para reflejar la selección vigente de luz y sonido sin darla por validada.
...
### 2026-08-30 — RU-03 y RU-07 precisados

- **Cambio:** RU-03 dejó de generalizar que los usos rutinarios de P6 conservan sentido y RU-07 separó control de la cadena de asociación.
- **Versión anterior:** la matriz extendía el valor de la videollamada a usos rutinarios y conservaba la cadena antigua de cinco componentes.
- **Motivo:** alinear requisitos con el corpus y con el protocolo vigente.
- **Alcance:** los requisitos, prioridades y estados de validación no cambian.
