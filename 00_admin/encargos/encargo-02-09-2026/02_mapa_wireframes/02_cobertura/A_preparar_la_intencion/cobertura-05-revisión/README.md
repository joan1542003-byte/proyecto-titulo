...
![Wireframe del estado 05 — Revisión](wireframe.png)

## Qué resuelve

Reúne los datos mínimos antes de vincular el testigo. Reduce errores de preparación y permite editar.

## Qué puede ocurrir después

Continuar para situar o volver a configurar.
