# Estado 04 — Permiso denegado

![Wireframe del estado 04 — Permiso denegado](wireframe.png)

## Qué resuelve

Mantiene una salida cuando Android no permite observar la condición elegida.

## Qué puede ocurrir después

Abrir ajustes, cambiar la condición o salir.
