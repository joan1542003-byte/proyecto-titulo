# Estado 33 — Vencimiento sin activación

![Wireframe del estado 33 — Vencimiento sin activación](wireframe.png)

## Qué resuelve

Cierra una vigencia que terminó sin una señal válida.

## Qué puede ocurrir después

Cerrar o preparar un nuevo ciclo.
