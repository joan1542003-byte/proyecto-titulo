# Estado 31 — Batería crítica

![Wireframe del estado 31 — Batería crítica](wireframe.png)

## Qué resuelve

Evita prometer un pulso cuando la energía no permite asegurarlo.

## Qué puede ocurrir después

Cargar, desarmar o cerrar.
