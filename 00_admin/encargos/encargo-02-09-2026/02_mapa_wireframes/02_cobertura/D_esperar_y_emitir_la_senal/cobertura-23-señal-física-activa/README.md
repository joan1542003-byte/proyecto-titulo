...
![Wireframe del estado 23 — Señal física activa](wireframe.png)

## Qué resuelve

Representa el único pulso situado del testigo. Es el único estado donde aparece el rojo semántico.
