# Estado 24 — Silenciar, ignorar o continuar

![Wireframe del estado 24 — Silenciar, ignorar o continuar](wireframe.png)

## Qué resuelve

Mantiene abiertas las respuestas posteriores sin registrar cumplimiento.

## Qué puede ocurrir después

Silenciar y cerrar; cualquier acción personal queda fuera del registro.
