# Estado 14 — Listo para armar

![Wireframe del estado 14 — Listo para armar](wireframe.png)

## Qué resuelve

Confirma que vínculo, lugar y prueba fueron revisados, pero aún no arma el ciclo.

## Qué puede ocurrir después

Continuar al armado, volver a probar o salir.
