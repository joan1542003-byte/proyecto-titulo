# Estado 09 — Testigo no reconocido

![Wireframe del estado 09 — Testigo no reconocido](wireframe.png)

## Qué resuelve

Separa un problema de identificación de una acción incorrecta de la persona.

## Qué puede ocurrir después

Volver a buscar o cancelar.
