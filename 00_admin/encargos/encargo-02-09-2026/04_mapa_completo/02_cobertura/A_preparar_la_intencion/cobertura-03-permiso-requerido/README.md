# Estado 03 — Permiso requerido

![Wireframe del estado 03 — Permiso requerido](wireframe.png)

## Qué resuelve

Explica por qué una condición necesita acceso de Android antes de solicitarlo.

## Qué puede ocurrir después

Conceder, cambiar la condición o volver.
