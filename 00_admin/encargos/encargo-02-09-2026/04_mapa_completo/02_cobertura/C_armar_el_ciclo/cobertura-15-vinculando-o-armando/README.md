# Estado 15 — Vinculando o armando

![Wireframe del estado 15 — Vinculando o armando](wireframe.png)

## Qué resuelve

Comunica la transición mientras se espera una confirmación técnica.

## Qué puede ocurrir después

Confirmar, reintentar o cancelar.
