# Estado 17 — Confirmación ambigua o fallo

![Wireframe del estado 17 — Confirmación ambigua o fallo](wireframe.png)

## Qué resuelve

Evita declarar un armado cuando el vínculo no entrega certeza suficiente.

## Qué puede ocurrir después

Reintentar, revisar el enlace o desarmar.
