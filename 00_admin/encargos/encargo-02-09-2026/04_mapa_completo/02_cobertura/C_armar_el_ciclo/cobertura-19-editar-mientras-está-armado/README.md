# Estado 19 — Editar mientras está armado

![Wireframe del estado 19 — Editar mientras está armado](wireframe.png)

## Qué resuelve

Impide modificar silenciosamente un ciclo vigente. Primero se debe desarmar o conservar la configuración actual.

## Qué puede ocurrir después

Desarmar y editar, o mantener el ciclo.
