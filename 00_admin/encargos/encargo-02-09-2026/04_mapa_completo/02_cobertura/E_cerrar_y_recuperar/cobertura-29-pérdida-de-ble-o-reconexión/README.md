# Estado 29 — Pérdida de BLE o reconexión

![Wireframe del estado 29 — Pérdida de BLE o reconexión](wireframe.png)

## Qué resuelve

Informa una interrupción del vínculo sin alterar silenciosamente el ciclo.

## Qué puede ocurrir después

Reconectar, reintentar o cerrar.
