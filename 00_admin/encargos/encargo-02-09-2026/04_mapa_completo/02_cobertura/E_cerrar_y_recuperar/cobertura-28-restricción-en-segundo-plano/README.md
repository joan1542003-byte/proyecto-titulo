# Estado 28 — Restricción en segundo plano

![Wireframe del estado 28 — Restricción en segundo plano](wireframe.png)

## Qué resuelve

Hace visible que el sistema no puede observar la condición con fiabilidad.

## Qué puede ocurrir después

Ajustar la restricción, mantener o cerrar.
