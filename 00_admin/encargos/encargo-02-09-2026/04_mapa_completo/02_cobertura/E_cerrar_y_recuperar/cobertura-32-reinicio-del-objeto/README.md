# Estado 32 — Reinicio del objeto

![Wireframe del estado 32 — Reinicio del objeto](wireframe.png)

## Qué resuelve

Comunica que el testigo perdió temporalmente su estado.

## Qué puede ocurrir después

Verificar el vínculo y rearmar de forma explícita.
