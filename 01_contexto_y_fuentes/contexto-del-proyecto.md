...
**Nombre vigente:** Relevo.  
**Ámbito:** proyecto de titulación en Diseño, Universidad Diego Portales.  
**Condición:** el resultado debe ser phygital; la dimensión física y la digital deben cumplir funciones necesarias dentro de una misma experiencia.
...
### 1. In(Visible): registro retrospectivo del descanso

La memoria histórica proponía una base doméstica donde se depositaba el teléfono. Un sensor registraba el tiempo sin pantalla y una visualización acumulativa buscaba favorecer el recuerdo episódico y la valoración retrospectiva del descanso.

Esta formulación aportó:

- la postura no punitiva;
- la importancia del gesto físico;
...
- bloqueador estricto;
- medidor general de productividad;
- solución para todo tipo de ocio digital;
- intervención cuya eficacia pueda asumirse antes de probarla.
