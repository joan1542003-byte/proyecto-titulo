...
El control editorial del 15 de septiembre registra **15.274 palabras de texto académico**, incluyendo preliminares y capítulos 1–13, sin bibliografía ni registro administrativo. Responde al objetivo aproximado de 15.000 solicitado por el autor. Los capítulos 1–13 suman 14.606; el archivo operativo completo contiene 19.452. El [control de extensión](auditoria-redaccion-v4-2026-08-26.md) declara el método y separa esos segmentos. La memoria conserva los catorce títulos y deberá volver a contarse cuando cambie. Permanecen abiertas la condición exacta de activación, la forma y materialidad finales, los costos definitivos y el aporte del objeto frente a una notificación. La dirección física ya acota las salidas a luz y sonido y selecciona una arquitectura portátil para prototipar, pero todavía no está construida ni validada. La identidad anterior fue retirada el 11 de septiembre. Desde el 15 de septiembre existe una primera dirección visual especificada para comparar; todavía no constituye una identidad definitiva.
...
En el ámbito visual, Relevo se conserva como nombre académico provisional y se comparará el descriptor `Una señal donde quieres empezar`. `Primer paso` queda como término analítico; la interfaz pregunta `¿Cómo podrías empezar?`. La primera dirección para prototipar, **Presencia útil**, emplea Source Sans 3, temas claro y oscuro, una base neutra y verde turquesa como color de presencia cuando una intención vuelve a ser relevante. La continuidad se sostiene mediante lenguaje, jerarquía y un único énfasis principal por pantalla o pieza, no mediante decoración repetida. La selección está especificada para permitir pruebas; todavía no constituye una identidad validada.

La revisión final retiró pasajes que explicaban la organización del escrito en vez del problema, describió la pregunta adicional de las entrevistas sin nombrar una etapa histórica y corrigió los costos documentados. La estructura y la formulación se mantienen; la bibliografía contiene 54 referencias. Las dos incorporaciones más recientes fundamentan por qué el color debe evaluarse según contexto y producto. No se añadieron resultados ni se cerraron decisiones pendientes de prueba.
...
La revisión textual del 9 de septiembre corrigió el acceso a la documentación oficial de vinculación Android en la bibliografía. La actualización de lenguaje y marca del 15 de septiembre lleva el texto académico a 15.274 palabras, incorpora dos fuentes cromáticas y conserva el estado de validación descrito arriba.
