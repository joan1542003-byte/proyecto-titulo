...
En el ámbito visual, Relevo se conserva como nombre académico provisional y se comparará el descriptor `Una señal cerca de tu primer paso`. La primera dirección para prototipar, **Presencia útil**, emplea Source Sans 3, temas claro y oscuro, una base neutra y verde turquesa como acento funcional. La continuidad se sostiene mediante lenguaje, jerarquía y un único énfasis principal por pantalla o pieza, no mediante decoración repetida. La selección está especificada para permitir pruebas; todavía no constituye una identidad validada.
...
La revisión textual del 9 de septiembre corrigió el acceso a la documentación oficial de vinculación Android en la bibliografía. La actualización visual del 15 de septiembre lleva el texto académico a 15.127 palabras y conserva las mismas 52 referencias y el estado de validación descrito arriba.
