...
El usuario principal no es una categoría fija: es una persona que, en un episodio concreto, mantiene una actividad digital mientras una alternativa que también valora pierde capacidad para orientar el siguiente paso. El usuario límite corresponde a episodios en que el ocio digital es elegido, significativo, reparador o coherente con la intención actual; allí Relevo no debería intervenir.
