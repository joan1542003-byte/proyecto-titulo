...
- **Cambio:** se creó una matriz completa para las 49 referencias de la memoria v4 y se registraron cuatro correcciones APA.
- **Versión anterior:** la auditoría activa declaraba una comprobación básica, pero no existía un registro verificable de cada entrada ni de las inconsistencias corregidas.
- **Motivo:** cerrar el cabo documental de correspondencia entre citas y referencias antes de una futura exportación.
- **Alcance:** la matriz no demuestra calidad o actualidad de cada fuente; registra que toda cita tiene referencia y toda referencia está citada.
