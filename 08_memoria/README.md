...
- Objetivo editorial: aproximadamente 15.000 palabras en preliminares y capítulos 1–13, sin bibliografía ni registro administrativo. La versión del 25 de septiembre tiene 15.137 palabras según `wc -w`; el [control de extensión](auditoria-redaccion-v4-2026-08-26.md) conserva los conteos anteriores.
- APA 7 en español.
...
- **Cambio:** la entrada registra 15.415 palabras académicas y 59 referencias.
- **Versión anterior:** informaba 15.274 palabras y 54 referencias antes de reconstruir el posicionamiento y la experiencia de marca.
- **Motivo:** conservar un control reproducible y sincronizado con la memoria vigente.
- **Alcance:** no se incorporaron resultados; el cambio corresponde a fundamentación y corrección conceptual.

### 2026-09-15 — Conteo posterior a la revisión de marca

- **Cambio:** la entrada registra 15.274 palabras académicas.
- **Versión anterior:** informaba 15.127 antes de desarrollar el lenguaje y relato de marca en el capítulo 11.
- **Motivo:** conservar un control reproducible después de cada modificación de la memoria.
- **Alcance:** bibliografía e historial administrativo permanecen excluidos.
...
- **Cambio:** Se corrigió la fecha del índice de pendientes para que corresponda al documento enlazado.
...
- **Cambio:** el índice registra 51 referencias después de incorporar la fuente oficial sobre la matriz de micro:bit.
- **Versión anterior:** la descripción permanecía en 49 entradas y no coincidía con la matriz ni con la memoria vigente.
- **Motivo:** mantener una sola cifra verificable en los accesos al documento académico.
- **Alcance:** el cambio describe correspondencia bibliográfica; no añade resultados ni valida la plataforma física.
...
- **Cambio:** se enlazó la matriz completa de citas y referencias y se actualizó la auditoría con el conteo vigente.
- **Versión anterior:** el índice solo remitía a una comprobación APA básica y a cifras anteriores a las últimas revisiones.
- **Motivo:** permitir un cierre editorial reproducible antes de la próxima exportación.
- **Alcance:** la comprobación formal no reemplaza la evaluación crítica de las fuentes ni la selección de anexos metodológicos.
...
- **Cambio:** se enlazaron la memoria vigente y la matriz E15.
- **Versión anterior:** solo existía una estructura provisional.
- **Motivo:** establecer una base única antes de desarrollar la estructura visual.
- **Alcance:** las versiones previas permanecen en `99_archivo`.
