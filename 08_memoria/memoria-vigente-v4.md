...
Algunas sesiones de ocio digital se prolongan sin que la persona vuelva a decidir si quiere continuar. En esos momentos, otra actividad que también deseaba realizar puede dejar de estar presente justo cuando todavía era posible comenzarla. Este proyecto tiene como objetivo diseñar y evaluar formativamente un sistema *phygital* —que combina un componente físico y uno digital— para ayudar a recuperar esa intención sin bloquear el teléfono ni calificar la decisión posterior.

La investigación combinó una revisión bibliográfica sobre ocio, conflicto entre metas, bienestar digital, memoria prospectiva e interacción tangible; ocho entrevistas semiestructuradas con personas de 19 a 27 años, analizadas con el método Framework; y una comparación de herramientas que miden, pausan, bloquean o alejan el teléfono. Los resultados mostraron que la duración no basta para juzgar una sesión, que las herramientas existentes actúan principalmente sobre la actividad presente y que conviene distinguir dos situaciones: una en que la intención alternativa pierde presencia y otra en que el ocio digital conserva sentido y no debe interrumpirse. De ellos se derivaron ocho criterios de diseño.

Como respuesta se propuso Relevo: una aplicación Android y un objeto que se deja donde comienza la actividad elegida —por ejemplo, junto al libro que se quiere leer— y que emitirá una señal sonora de unos treinta segundos cuando se cumpla una condición configurada. Se desarrolló un prototipo Android que prepara el recordatorio y emite un aviso sonoro, todavía sin una prueba completa en un teléfono real, y se diseñó una prueba de 21 días en hogares para comparar la señal situada con la misma señal en un lugar neutro y con una notificación digital. El aporte del objeto físico sigue siendo una hipótesis que esa prueba deberá confirmar o descartar.

**Palabras clave:** ocio digital, memoria prospectiva, autonomía, diseño phygital.

## Abstract

Some digital leisure sessions continue without the person deciding again whether to go on. At such moments, another activity they also wanted to do may fade from view precisely when it could still begin. This project aims to design and formatively evaluate a phygital system, combining a physical and a digital component, that helps people recover that intention without blocking the phone or judging what they decide next.

The research combined a literature review on leisure, goal conflict, digital wellbeing, prospective memory and tangible interaction; eight semi-structured interviews with people aged 19 to 27, analysed with the Framework method; and a comparison of tools that measure, pause, block or distance the phone. The results showed that duration alone cannot establish the value of a session, that existing tools mostly act on the current activity, and that two situations should be distinguished: one in which the alternative intention loses salience and another in which digital leisure remains meaningful and should not be interrupted. Eight design criteria were derived from these findings.

In response, Relevo was proposed: an Android application and an object placed where the chosen activity begins (for example, next to the book one wants to read), which will emit a sound cue of about thirty seconds when a user-defined condition is met. An Android prototype was developed that sets up the reminder and plays a sound cue, not yet fully tested on a real phone, and a 21-day home study was designed to compare the situated cue with the same cue in a neutral place and with a digital notification. The contribution of the physical object remains a hypothesis that this study must confirm or reject.
...
Lukoff et al. (2018) estudiaron qué hace que el uso del teléfono se perciba como significativo o carente de sentido. Usarlo por hábito para pasar el tiempo, para entretenerse o para mirar redes sociales de forma pasiva se asoció con menos sentido y, en las entrevistas, con una pérdida de autonomía; aun así, algunas personas valoraban esos momentos como una breve evasión de situaciones difíciles. Meier y Reinecke (2021) integraron 34 revisiones sobre comunicación mediada, redes sociales y salud mental: hallaron, en general, una asociación negativa pequeña, pero con efectos complejos que dependen de qué aspecto del uso y qué indicador de salud mental se estudien. Radtke et al. (2022), por su parte, revisaron intervenciones de desconexión digital y encontraron resultados positivos, nulos y negativos. En conjunto, estos antecedentes desaconsejan tratar la reducción del uso como una solución universal y orientan el análisis hacia la relación entre actividad e intención, como hizo el estudio descrito en el planteamiento (de Segovia Vicente et al., 2024).
...
En el campo de la **interacción tangible**, que incorpora objetos físicos a la forma de representar o manipular información, *The Tangible Reminder* fue una instalación física para seguir citas y plazos, ver su estado y recibir avisos de los compromisos próximos (Hermann et al., 2007). Es un ejemplo de recordatorio repartido entre información digital, presencia física y entorno; sin embargo, estaba pensado para citas con fecha y hora, no para sesiones de ocio digital ni para intenciones que la persona puede decidir no realizar.
...
La valoración de lo digital depende de la relación entre propósito y experiencia. Una misma aplicación puede sostener una conversación importante o una secuencia rutinaria, y el sentido de una sesión se asocia con el motivo y el tipo de uso (Lukoff et al., 2018). Como los efectos sobre el bienestar dependen de qué aspecto del uso se estudia (Meier & Reinecke, 2021), no conviene inferir bienestar o malestar desde una categoría general como el tiempo de pantalla. Para esta investigación, la unidad relevante es el **episodio**: una situación concreta con un inicio, una actividad, un propósito, otras intenciones posibles y una valoración posterior.
...
Kirsh (1995) explica que la forma de disponer los objetos puede simplificar la elección, la percepción y el cálculo mental, como ocurre al ordenar los ingredientes antes de cocinar. Del mismo modo, un objeto dejado junto a la puerta puede convertir el entorno en un recordatorio y facilitar el comienzo de la acción. El lugar puede favorecer el recuerdo, aunque la proximidad no asegura actuar (O’Rear & Radvansky, 2019; Sohn et al., 2005); importan su significado personal y la posibilidad de percibir la señal entre otras actividades. Una meta amplia también debe distinguirse de su comienzo: hacer ejercicio puede empezar al preparar las zapatillas y dibujar, al disponer los materiales. Esta distinción abre una pregunta: qué separa recordar una actividad de reconocer que se puede empezar ahora.
...
3. Comparar la señal situada con la misma señal en un lugar neutro y con una notificación digital, para establecer si el lugar y la capa física aportan una diferencia reconocible.
...
| Desarrollo electrónico | Resuelve energía, enlace, sonido y control. | Fiabilidad, seguridad y mantenimiento. |
...
La condición de activación aún no está decidida. Puede basarse en continuidad de uso, tiempo acumulado dentro de un periodo o una franja horaria. El prototipo utiliza provisionalmente el tiempo que las aplicaciones elegidas pasan en primer plano, es decir, abiertas en la pantalla, porque es fácil de explicar y de ajustar; su pertinencia frente a las otras alternativas no está probada. Cada alternativa debe explicarse con ejemplos. El sistema no utiliza expresiones como detectar distracción o reconocer pérdida de control, porque esos estados no pueden deducirse desde un registro técnico.
...
La forma circular podría reducir la dependencia de una orientación frontal. Se comparará con un rectángulo redondeado de volumen interno equivalente mediante estabilidad, manipulación, percepción y acceso al control. El tamaño exterior previsto es de 42–48 mm de diámetro y 12–16 mm de grosor, con espacio para montaje y reparación. Dimensiones, peso, color y material se ajustarán tras comprobar señal, autonomía y distribución interior.

El testigo debe distinguir tres situaciones: reposo, señal y problema técnico. En las primeras pruebas, la aplicación informará el estado técnico, y las luces propias de la placa se cubrirán para que no se confundan con una señal. Si más adelante el objeto avisa por sí mismo de batería baja o desconexión, ese aviso necesitará un patrón distinto de la señal, comprobado frente al riesgo de confusión.

El lugar es una relación elegida, no una coordenada detectada: junto al libro para leer o a los materiales para dibujar. El objeto puede asociarse con actividades diferentes en cada ciclo, manteniendo una sola intención activa, pero esta adaptabilidad no implica universalidad. Como las superficies, los objetos y la convivencia cambian, cada reubicación exige probar de nuevo la señal, que puede oírse peor, pasar inadvertida o conservar una asociación anterior, y la señal debe mantenerse discreta sin exponer el contenido de la intención.
...
La comunicación entre la aplicación y un testigo propio aún no está implementada ni validada. El teléfono comprobaría la condición autorizada en el propio dispositivo, como ya lo hace el prototipo, y enviaría una orden al objeto mientras el ciclo esté vigente. Bluetooth de baja energía, una comunicación inalámbrica de corto alcance, conectaría aplicación y objeto. Este verificaría el ciclo, emitiría el patrón y volvería a reposo al terminar la señal o al ser silenciado.
...
| Recibir y cerrar | Percibir la señal y conservar una salida local. | Patrón reproducible y término sin insistencia. | Tono y silencio implementados con parlante o teléfono; el tono sigue hasta silenciarlo; la versión 2.7 lo limitará a unos 30 segundos; prueba en equipos reales pendiente. |
...
El segundo nivel integraría el testigo portátil mediante una XIAO nRF52840, una placa electrónica del tamaño de una estampilla, batería recargable protegida, un transductor sonoro pequeño —componente que convierte una señal eléctrica en sonido— y un control local. La placa reúne Bluetooth de baja energía y gestión de carga en 21 × 17,8 mm, por lo que reduce el tamaño y el número de conexiones frente a los montajes de mesa estudiados antes, que unían componentes separados y no llegaron a construirse (Seeed Studio, 2026). BleenyButton demuestra una disposición abierta de la misma placa con batería, botón y carcasa atornillada; se estudia como antecedente constructivo, no como solución de uso. Reutilizar sus archivos o su código obliga a respetar su licencia GPL-3.0, una licencia de código abierto que exige compartir las obras derivadas en las mismas condiciones (Asterics Foundation, s. f.).
...
La condición de activación, los parámetros del sonido, la forma, la autonomía, los materiales y los costos reales continúan abiertos. Tampoco se ha demostrado que el objeto ayude a recuperar intenciones, que el lugar produzca una diferencia o que la experiencia sea preferible a una notificación.
...
**Banco técnico.** Ensayo del material sin participantes, que comprueba la llegada de la orden, el patrón de la señal y el silencio local.
...
**Condición de activación.** Evento observable, que la persona entiende y puede modificar, que hace sonar la señal; en el prototipo, el tiempo acumulado en las aplicaciones elegidas.
