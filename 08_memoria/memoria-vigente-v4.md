...
La investigación combinó una revisión bibliográfica sobre ocio, conflicto entre metas, bienestar digital, memoria prospectiva e interacción tangible; ocho entrevistas semiestructuradas con personas de 19 a 27 años, analizadas con el método Framework; y una comparación de herramientas que miden, pausan, bloquean o alejan el teléfono. Los resultados mostraron que la duración no basta para juzgar una sesión, que las herramientas existentes actúan sobre todo sobre la actividad presente y que conviene distinguir dos situaciones: una en que la intención alternativa pierde presencia y otra en que el ocio digital conserva sentido y no debe interrumpirse. De ellos se derivaron ocho criterios de diseño.

Como respuesta se propuso Relevo: una aplicación Android y un objeto que se deja junto al primer paso de la actividad elegida —por ejemplo, el libro que se quiere leer— y que emitirá una señal sonora breve cuando se cumpla una condición configurada. Se desarrolló un prototipo Android que prepara el recordatorio y emite un aviso sonoro, todavía sin una prueba completa en un teléfono real, y se diseñó una prueba de 21 días en hogares que compara la señal situada con la misma señal en un lugar neutro y con una notificación digital. El aporte del objeto físico sigue siendo una hipótesis que esa prueba deberá confirmar o descartar.
...
In response, Relevo was proposed: an Android application and an object left next to the first step of the chosen activity (for example, the book one wants to read), which will emit a brief sound cue when a user-defined condition is met. An Android prototype was developed that sets up the reminder and plays a sound cue, not yet fully tested on a real phone, and a 21-day home study was designed to compare the situated cue with the same cue in a neutral place and with a digital notification. The contribution of the physical object remains a hypothesis that this study must confirm or reject.
...
Lukoff et al. (2018) estudiaron qué hace que el uso del teléfono se perciba como significativo o carente de sentido. Usarlo por hábito para pasar el tiempo, para entretenerse o para mirar redes sociales de forma pasiva se asoció con menos sentido y, en las entrevistas, con una pérdida de autonomía; aun así, algunas personas valoraban esos momentos como una breve evasión de situaciones difíciles. Meier y Reinecke (2021) integraron 34 revisiones sobre comunicación mediada, redes sociales y salud mental: en conjunto hallaron una asociación negativa pequeña, pero con efectos complejos que dependen de qué aspecto del uso y qué indicador de salud mental se estudien. Radtke et al. (2022), por su parte, revisaron intervenciones de desconexión digital y encontraron resultados positivos, nulos y negativos. En conjunto, estos antecedentes desaconsejan tratar la reducción del uso como una solución universal y orientan el análisis hacia la relación entre actividad e intención, como el estudio descrito en el planteamiento (de Segovia Vicente et al., 2024).
...
Kirsh (1995) explica que la forma de disponer los objetos puede simplificar la elección, la percepción y el cálculo mental, como ocurre al ordenar los ingredientes antes de cocinar. Del mismo modo, un objeto dejado junto a la puerta convierte el entorno en un recordatorio y facilita comenzar la acción. El lugar puede favorecer el recuerdo, aunque la proximidad no asegura actuar (O’Rear & Radvansky, 2019; Sohn et al., 2005); importan su significado personal y la posibilidad de percibir la señal entre otras actividades. Una meta amplia también debe distinguirse de su comienzo: hacer ejercicio puede empezar al preparar las zapatillas y dibujar, al disponer los materiales. Esta distinción abre una pregunta: qué separa recordar una actividad de reconocer que se puede empezar ahora.
...
| Recibir y cerrar | Percibir la señal y conservar una salida local. | Patrón reproducible y término sin insistencia. | Tono y silencio implementados con parlante o teléfono; el tono sigue hasta silenciarlo, sin término automático; prueba en equipos reales pendiente. |
...
«Primer paso» se mantiene como concepto analítico para describir una acción breve, concreta y disponible que permite comenzar una actividad elegida. No aparece como expresión de los participantes P1–P8 y puede admitir interpretaciones diferentes sin una definición. Tampoco se limita a una decisión de interfaz: es una hipótesis transversal que debe ayudar a formular la actividad, elegir dónde ubicar el objeto y reconstruir el sentido de la señal. El prototipo pregunta «¿Cómo empezarás?», y las pruebas compararán esa formulación con alternativas cotidianas equivalentes, como «¿Cómo podrías empezar?». Si concretar el comienzo no mejora configuración, ubicación y recuperación, el concepto deberá simplificarse o retirarse.
...
El primer nivel técnico utilizará una micro:bit V2, una placa electrónica educativa de bajo costo que incluye Bluetooth, un pequeño parlante, botones y una grilla de 25 luces rojas. Servirá para comprobar la conexión con Android, el sonido y la posibilidad de apagar la señal desde el propio objeto; sus luces se cubrirán para que no actúen como señal (Micro:bit Educational Foundation, s. f.-a, s. f.-b). La prueba con participantes no depende de este nivel: usa un parlante comercial.
...
La prueba comienza con una sesión presencial en el hogar. La persona formula una intención y su primer paso, sitúa el parlante junto a ese comienzo y configura un límite de ocho minutos en una aplicación que usará durante la espera; ese intervalo es un parámetro de la prueba, no el momento ideal de intervención, y la condición de activación sigue abierta.

El investigador registrará cuatro momentos: percepción de la señal, atribución al sistema, recuperación de la intención e identificación del primer paso. Por separado se comprobará si la persona entiende que puede ignorar, silenciar o seguir la señal; iniciar la actividad no será requisito. Si el significado no puede reconstruirse o las salidas no se comprenden, la configuración se reformulará antes de avanzar.

Durante las tres semanas siguientes, cada persona usa Relevo en su vida cotidiana bajo una condición distinta por semana: el parlante junto al primer paso, el mismo parlante en un lugar neutro de la casa y el teléfono, que emite el mismo sonido con una notificación genérica —«Relevo · Tu intención está disponible»— sin mostrar la intención ni el primer paso. El orden se distribuye entre las seis secuencias posibles, una por participante, para reducir el efecto de practicar antes con una alternativa; las intenciones pueden cambiar entre semanas, y esa diferencia se declara como límite. Después de cada señal, la aplicación pregunta con un toque si la persona supo qué quería hacer y cómo empezar antes de mirar el teléfono, y qué decidió; además registra cuánto tardó en responder y cuánto siguió en las aplicaciones elegidas. Al final de cada semana se valoran carga, intrusión y relación entre señal y lugar. La comparación se limita al aviso genérico y no permite afirmar superioridad frente a recordatorios que expliciten el contenido; si ese aviso ofrece el mismo apoyo con menos esfuerzo, se reconsiderará la configuración física.
...
**Condición de activación.** Evento observable, comprensible y modificable por la persona que hace emitir la señal; en el prototipo, el tiempo acumulado en las aplicaciones elegidas.
...
**Pulso ambiental.** Señal sonora breve, de unos treinta segundos, que se detiene sola y llama la atención sin dar una instrucción.
