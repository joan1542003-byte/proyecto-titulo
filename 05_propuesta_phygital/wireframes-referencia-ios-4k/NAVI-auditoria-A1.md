# NAVI — Auditoría de A1 · Configuración iOS 4K

## Alcance

Esta intervención corrige exclusivamente la copia del estado 03, `Permiso requerido`, en `A1-configuracion-ios-4k.png`. La lámina A2 se utilizó como referencia visual obligatoria para conservar composición, jerarquía, paleta y tratamiento de estados técnicos. No se modificó A2 ni se generaron otras láminas.
...
- `A2-configuracion-ios-4k.png`, como referencia visual.
...
- Salida nativa de `image_gen`: `1672 × 941 px`.
- Normalización: ampliación proporcional con ajuste a lienzo 16:9 y fondo `#FCFBF8`, sin estirar ni recortar el contenido.
- Archivo final: `A1-configuracion-ios-4k.png`.
- Resolución final verificada: `3840 × 2160 px`.
- Método: built-in `image_gen` para la edición y normalización local posterior para cumplir el formato final.
