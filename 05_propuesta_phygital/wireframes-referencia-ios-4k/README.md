...
| --- | --- | --- |
| [A1](A1-configuracion-ios-4k.png) | 01–03 | Inicio, datos incompletos y permiso requerido. |
| [A2](A2-configuracion-ios-4k.png) | 04–06 | Permiso no concedido, revisión y salida voluntaria. |
| [B1a](B1a-vinculacion-ios-4k.png) | 07–08 | Búsqueda, identificación y elección del testigo. |
| [B1b](B1b-vinculacion-ios-4k.png) | 09–10 | Testigo incorrecto y batería baja. |
| [B2a](B2a-prueba-ios-4k.png) | 11–12 | Prueba situada y señal no percibida. |
| [B2b](B2b-prueba-ios-4k.png) | 13–14 | Señal intrusiva y preparación previa al armado. |
| [C1](C1-armado-ios-4k.png) | 15–17 | Armado en curso, confirmación y fallo ambiguo. |
| [C2](C2-armado-ios-4k.png) | 18–19 | Desarmado voluntario y edición durante un ciclo activo. |
| [D1](D1-espera-ios-4k.png) | 20–22 | Espera, orden válida y orden expirada. |
| [D2](D2-senal-ios-4k.png) | 23–24 | Pulso situado y respuestas igualmente válidas. |
| [E1](E1-cierre-ios-4k.png) | 25–27 | Cierre, cambio de intención y permiso revocado. |
| [E2](E2-recuperacion-ios-4k.png) | 28–30 | Segundo plano, pérdida de vínculo y cambio de lugar. |
| [E3](E3-recuperacion-ios-4k.png) | 31–33 | Batería crítica, reinicio y vencimiento sin activación. |
| [E4](E4-finales-ios-4k.png) | 34–35 | Rearme explícito y eliminación. |
...
El sistema gráfico completo se documenta en [STYLE-CONTRACT.md](STYLE-CONTRACT.md). Los prompts, correcciones y decisiones de producción se conservan en [PROMPTS-LINK.md](PROMPTS-LINK.md), [PROMPTS-ALOY.md](PROMPTS-ALOY.md), [PROMPTS-CORTANA.md](PROMPTS-CORTANA.md) y [NAVI-auditoria-A1.md](NAVI-auditoria-A1.md). El cierre transversal está registrado en [GERALT-auditoria-final.md](GERALT-auditoria-final.md).

## Producción y auditoría

Las imágenes fueron generadas mediante `image_gen`, revisadas por familias y normalizadas proporcionalmente a 4K. La supervisión verificó cobertura correlativa, legibilidad, coherencia de acciones y ausencia de patrones visuales propios de Android. Las correcciones finales evitaron un armado prematuro en el estado 14, precisaron la orden del estado 21, exigieron repetir la prueba tras el reinicio del estado 32 y mantuvieron el rearme del estado 34 como decisión explícita.
