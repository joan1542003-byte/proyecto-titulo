# Registro de producción y auditoría — Estados 07–14

## Alcance

Este registro documenta la producción de cuatro láminas visuales para los estados 07–14 del ciclo mínimo de Relevo. Las imágenes son referencias de baja/media fidelidad para calcar y discutir en Figma; no son una interfaz final ni una validación del producto.

**Fecha:** 25 de agosto de 2026  
**Tipo de pieza:** referencia visual raster 4K
**Referencia visual:** `A2-configuracion-4k.png`
**Contrato visual consultado:** `contrato-visual.md` — no fue modificado.

## Fuentes de decisión

Antes de producir las láminas se leyeron de forma completa:
...
- `05_propuesta_phygital/wireframes-referencia-4k/A2-configuracion-4k.png` como referencia visual.
...
> Crear una lámina horizontal 16:9 con dos wireframes móviles verticales, grandes, completos y separados. Usar la referencia `A2-configuracion-4k.png` para la retícula, el fondo cálido `#FCFBF8`, la retícula tenue, las tarjetas agrupadas, los radios suaves, los bordes grises y la jerarquía tipográfica. Crear una composición original inspirada en patrones contemporáneos de composición digital, sin imitar una interfaz de Android ni convertirla en UI final. Usar una familia sans serif de sistema equivalente a Inter, blanco, gris cálido y carbón, sin color semántico saturado. Integrar una viñeta lineal del mismo testigo físico compacto y redondeado, sin pantalla, junto a la interfaz móvil. Mantener todos los elementos y conectores dentro de sus marcos, sin barra de estado, barra de navegación Android, botón atrás de Android, menú de tres puntos, logos, fotografías, manos ni marcas.
...
**Archivo final:** `B1a-vinculacion-4k.png`
...
**Archivo final:** `B1b-vinculacion-4k.png`
...
**Archivo final:** `B2a-prueba-4k.png`
...
La primera versión de esta lámina fue descartada durante la auditoría porque utilizaba un testigo cilíndrico distinto y dejaba conectores visuales prolongándose hacia el borde inferior. Se produjo una segunda versión con la silueta redondeada común a las láminas de vinculación y con todos los conectores contenidos dentro de los marcos.

### B2b — Prueba: intrusión y armado explícito

**Archivo final:** `B2b-prueba-4k.png`
...
La primera versión mostraba una silueta cilíndrica en ambas pantallas. Se descartó por inconsistencia con B1a, B1b y la versión final de B2a. La versión final repite el testigo compacto redondeado y mantiene las líneas dentro de los marcos.

## Normalización técnica

Las salidas originales midieron `1672 × 941 px`. Cada selección final fue ampliada proporcionalmente al lienzo exacto de `3840 × 2160 px` mediante interpolación bicúbica de alta calidad. La proporción se conservó; el ajuste dejó un margen horizontal de dos píxeles integrado al fondo cálido para evitar estirar la imagen.

| Archivo | Dimensión final | Estados | Resultado de auditoría |
| --- | --- | --- | --- |
| `B1a-vinculacion-4k.png` | 3840 × 2160 | 07–08 | Aprobada |
| `B1b-vinculacion-4k.png` | 3840 × 2160 | 09–10 | Aprobada |
| `B2a-prueba-4k.png` | 3840 × 2160 | 11–12 | Aprobada tras segunda versión |
| `B2b-prueba-4k.png` | 3840 × 2160 | 13–14 | Aprobada tras segunda versión |
...
- La retícula, el fondo cálido, los radios, las tarjetas y la jerarquía mantienen continuidad con `A2-configuracion-4k.png`.
...
No se modificaron `contrato-visual.md`, `A2-configuracion-4k.png`, la memoria, los requisitos del Encargo 17, el anexo de cobertura ni los archivos de otras series visuales. Las salidas originales permanecen fuera del repositorio; aquí solo se conservaron las cuatro selecciones finales normalizadas.

## Registro de cambios (disclaimer)

**Archivo anterior:** este registro se llamaba `PROMPTS-LINK.md`.
...
**Versión anterior:** no existía un registro específico para estas cuatro láminas.

**Motivo:** dejar trazabilidad de cómo se produjeron y revisaron las imágenes, sin modificar el contrato visual ni presentar las referencias como una interfaz final o como validación del producto.
...
- **Archivo afectado:** `B2b-prueba-4k.png`.
...
- **Conservado:** se mantuvieron la composición, ilustraciones, tarjetas, jerarquía, escala de grises, formato 3840 × 2160 y todos los demás textos y elementos de la lámina. Se aplicó una corrección focalizada de texto para no rehacer la lámina completa.

### 2026-09-02 — Normalización del nombre y del registro

- **Cambio:** se eliminó la referencia a una plataforma del nombre de la carpeta y de los archivos, se reemplazaron nombres operativos por nombres descriptivos y se retiraron identificadores de colaboración del encabezado.
- **Cómo estaba antes:** la carpeta y parte de sus registros usaban “iOS”, nombres de trabajo y una herramienta específica, aunque estas láminas solo cumplen una función de referencia compositiva.
