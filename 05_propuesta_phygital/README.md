...
- propuesta de valor y razones de existencia;
- requisitos y no requisitos;
- arquitectura del sistema;
- flujo del usuario;
- flujo técnico;
- flujo de diseño y producción;
- estados, errores y casos límite;
- alternativas consideradas y criterios de selección;
- lenguaje formal, material y sensorial;
- privacidad, autonomía y accesibilidad.

## Pregunta de control

Si una función puede resolverse de igual manera mediante una notificación convencional, debe justificarse por qué requiere un objeto físico. La condición phygital no puede ser decorativa.
...
- **Cambio:** los documentos activos enlazan la aplicación Android 2.6 y señalan en qué amplía el wireframe v1.
- **Versión anterior:** el índice terminaba en el cierre del wireframe v1, sin indicar que ya existe una implementación.
- **Motivo:** evitar que el wireframe se lea como la última versión del recorrido.
...
- **Cambio:** se enlazaron requisitos, tres interacciones y memoria vigente.
- **Versión anterior:** solo se indicaban documentos previstos.
- **Motivo:** registrar el paso desde investigación hacia estructura.
- **Alcance:** no se desarrolló visualidad ni pantalla física.
